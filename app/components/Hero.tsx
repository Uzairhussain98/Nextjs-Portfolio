  ...
  return (
    <div className="px-4 md:px-0  md:w-11/12  md:ml-auto flex md:bg-[url('/home-bg.svg')] bg-right  h-[700px] bg-opacity-25 ">
      <div className=" flex flex-col  mt-32 opacity-100   gap-8 ">
        ...
        <h3 className="text-6xl text-black  font-bold">Uzair Hussain</h3>
        ...
        <button className="bg-[#ef9218] font-semibold text-[12px] border-2 border-black p-3 text-base tracking-[.20em] self-start rounded-full px-12 hover:scale-105 transition-all ease-in-out duration-1000">
          CHECK OUT MY CV !
        </button>
      </div>
    </div>
